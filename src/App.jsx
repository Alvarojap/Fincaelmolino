...
const LIMP_T = [
  { id:"l1", txt:"Limpiar y desinfectar baños",     zona:"Baños"        },
  { id:"l2", txt:"Barrer y fregar suelos",          zona:"General"      },
  { id:"l3", txt:"Limpiar cocina completa",         zona:"Cocina"       },
  { id:"l4", txt:"Cambiar ropa de cama",            zona:"Habitaciones" },
  { id:"l5", txt:"Limpiar ventanas interiores",     zona:"General"      },
  { id:"l6", txt:"Aspirar alfombras y tapetes",     zona:"Salones"      },
  { id:"l7", txt:"Limpiar salón principal",         zona:"Salones"      },
  { id:"l8", txt:"Reponer consumibles",             zona:"Baños"        },
  { id:"l9", txt:"Limpiar terraza y exterior",      zona:"Exterior"     },
  { id:"l10",txt:"Revisión electrodomésticos",      zona:"Cocina"       },
];
const ESTADOS = [
